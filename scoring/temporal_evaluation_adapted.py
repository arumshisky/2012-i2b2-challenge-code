...
def get_relations(tlink_xml,dicsys): 
    '''
    text = open(file).read()
...
def evaluate_two_files(arg1, arg2,dic,dicsys):
    ...
    if debug >= 1: 
        print '\n\n Evaluate', arg1, arg2
    gold_annotation = get_relations(arg1,dicsys)
...
##    ref_minus = len(tg_gold.final_relations.split('\n'))-1
    ...
    #return tg_system
    return len(tg_system.final_relations.split('\n'))-1, len(tg_gold.final_relations.split('\n'))-1, prec_matched, rec_matched
